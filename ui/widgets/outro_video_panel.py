...
class OutroVideoPanel(QWidget):
    """Panel for configuring outro video settings."""
    ...
    def _init_ui(self):
        ...
        # Group box
        self.group_box = QGroupBox("Outro Video")
        group_layout = QVBoxLayout()
        
        # Enable checkbox
        self.enable_checkbox = QCheckBox("Enable Outro Video")
        ...
        self.file_edit.setPlaceholderText("Select outro video...")

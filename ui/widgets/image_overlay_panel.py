...
class ImageOverlayPanel(QWidget):
    """Panel for configuring image overlay settings."""
    ...
    def _init_ui(self):
        ...
        # Group box
        self.group_box = QGroupBox("Image Overlay")
        group_layout = QVBoxLayout()
        
        # Enable checkbox
        self.enable_checkbox = QCheckBox("Enable Image Overlay")
        ...
        self.file_edit.setPlaceholderText("Select image file...")
        ...
        # Preview
        self.preview_label = QLabel("Preview: (no image)")
